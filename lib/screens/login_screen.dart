...
import 'package:electrify/services/network_service.dart';
import 'package:electrify/utils/constants.dart';
import 'package:electrify/utils/dialogues.dart';
import 'package:electrify/utils/validation.dart';
import 'package:electrify/widgets/primary_button.dart';
    ...
    if (_formKey.currentState.validate()) {
      if (await NetworkService.checkDataConnectivity()) {
        ...
        if (result is bool && result) {
          Get.offAndToNamed(HomeScreen.ROUTE_NAME);
